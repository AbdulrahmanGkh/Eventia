...
const DUMMY_EVENTS = [
    ...
    },
    {
        ...
        price: "150",
        tickets: [{ name: 'Standard', price: '150' }, { name: 'VIP', price: '350' }],
        status: "Upcoming",
    ...
    },
    {
        ...
        price: "200",
        tickets: [{ name: 'Standard', price: '200' }, { name: 'VIP', price: '500' }],
        status: "Pending",
    ...
    },
    {
        ...
        price: "100",
        tickets: [{ name: 'Standard', price: '100' }, { name: 'VIP', price: '250' }],
        status: "Past",
        withdrawalPolicy: "strict",
    ...
    },
    {
        ...
        price: "50",
        tickets: [{ name: 'Standard', price: '50' }, { name: 'VIP', price: '150' }],
        status: "Upcoming",
...
const DUMMY_ALL_REGISTRATIONS = [
    ...
    { id: "ar1",  eventId: "101", name: "Ahmed Al-Rashid",    birthday: "1998-05-12", ticketType: "VIP",      ticketPrice: "599", registeredDate: "2025-12-20", status: "Active", satisfactionScore: 5 },
    { id: "ar2",  eventId: "101", name: "Sara Al-Dosari",     birthday: "2001-08-23", ticketType: "Standard", ticketPrice: "299", registeredDate: "2025-12-22", status: "Active", satisfactionScore: 4 },
    { id: "ar3",  eventId: "101", name: "Khalid Al-Mutairi",  birthday: "1985-02-14", ticketType: "VIP",      ticketPrice: "599", registeredDate: "2025-12-25", status: "Active", satisfactionScore: 5 },
    { id: "ar4",  eventId: "101", name: "Nora Al-Harbi",      birthday: "1992-11-03", ticketType: "Standard", ticketPrice: "299", registeredDate: "2026-01-02", status: "Active", satisfactionScore: 4 },
    { id: "ar5",  eventId: "101", name: "Fahad Al-Otaibi",    birthday: "1975-06-30", ticketType: "Standard", ticketPrice: "299", registeredDate: "2026-01-05", status: "Active", satisfactionScore: 3 },
    { id: "ar6",  eventId: "101", name: "Layla Al-Zahrani",   birthday: "2003-01-18", ticketType: "Standard", ticketPrice: "299", registeredDate: "2026-01-08", status: "Active", satisfactionScore: 5 },
    { id: "ar7",  eventId: "101", name: "Omar Bin Saleh",     birthday: "1990-09-07", ticketType: "VIP",      ticketPrice: "599", registeredDate: "2026-01-10", status: "Active", satisfactionScore: 4 },
    ...
    { id: "ar10", eventId: "101", name: "Maha Al-Subaie",     birthday: "1988-07-15", ticketType: "VIP",      ticketPrice: "599", registeredDate: "2026-01-15", status: "Active", satisfactionScore: 4 },
    { id: "ar11", eventId: "101", name: "Youssef Al-Dossary", birthday: "2000-03-28", ticketType: "Standard", ticketPrice: "299", registeredDate: "2026-01-18", status: "Active", satisfactionScore: 5 },
    { id: "ar12", eventId: "101", name: "Huda Al-Enezi",      birthday: "1982-10-09", ticketType: "Standard", ticketPrice: "299", registeredDate: "2026-01-20", status: "Active", satisfactionScore: 4 },

    // --- Riyadh Art Week (102) — 8 attendees ---
    { id: "ar13", eventId: "102", name: "Amal Al-Ghamdi",     birthday: "1997-04-05", ticketType: "General",  ticketPrice: "150", registeredDate: "2025-12-28", status: "Active", satisfactionScore: 5 },
    { id: "ar14", eventId: "102", name: "Saad Al-Tamimi",     birthday: "1980-12-19", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-02", status: "Active", satisfactionScore: 4 },
    { id: "ar15", eventId: "102", name: "Dana Al-Rasheed",    birthday: "2004-06-11", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-05", status: "Active", satisfactionScore: 5 },
    { id: "ar16", eventId: "102", name: "Mansour Al-Bloushi", birthday: "1965-09-25", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-08", status: "Active", satisfactionScore: 3 },
    ...
    { id: "ar18", eventId: "102", name: "Faisal Al-Juhani",   birthday: "1999-08-30", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-11", status: "Active", satisfactionScore: 4 },
    { id: "ar19", eventId: "102", name: "Nouf Al-Mutlaq",     birthday: "1987-05-17", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-12", status: "Active", satisfactionScore: 5 },
    { id: "ar20", eventId: "102", name: "Bader Al-Harthy",    birthday: "1972-11-02", ticketType: "General",  ticketPrice: "150", registeredDate: "2026-01-13", status: "Active", satisfactionScore: 4 },

    // --- Business Summit (103) — 8 attendees ---
    { id: "ar21", eventId: "103", name: "Sultan Al-Fahad",    birthday: "1978-03-08", ticketType: "Executive", ticketPrice: "750", registeredDate: "2026-01-20", status: "Active", satisfactionScore: 5 },
    { id: "ar22", eventId: "103", name: "Haifa Al-Subaihi",   birthday: "1991-07-22", ticketType: "Standard",  ticketPrice: "450", registeredDate: "2026-01-22", status: "Active", satisfactionScore: 4 },
    { id: "ar23", eventId: "103", name: "Abdulaziz Al-Nasr",  birthday: "1983-01-14", ticketType: "Executive", ticketPrice: "750", registeredDate: "2026-01-25", status: "Active", satisfactionScore: 5 },
    ...
    { id: "ar25", eventId: "103", name: "Nawaf Al-Dosari",    birthday: "1970-06-18", ticketType: "Executive", ticketPrice: "750", registeredDate: "2026-01-30", status: "Active", satisfactionScore: 4 },
    { id: "ar26", eventId: "103", name: "Ghada Al-Otaibi",    birthday: "2002-09-05", ticketType: "Standard",  ticketPrice: "450", registeredDate: "2026-02-01", status: "Active", satisfactionScore: 3 },
    { id: "ar27", eventId: "103", name: "Rakan Al-Shehri",    birthday: "1986-04-12", ticketType: "Executive", ticketPrice: "750", registeredDate: "2026-02-03", status: "Active", satisfactionScore: 5 },
    { id: "ar28", eventId: "103", name: "Asma Al-Harthi",     birthday: "1994-12-28", ticketType: "Standard",  ticketPrice: "450", registeredDate: "2026-02-05", status: "Active", satisfactionScore: 4 },

    // --- Education Conference (105, Past) — 6 attendees ---
    { id: "ar29", eventId: "105", name: "Ibrahim Al-Qahtani", birthday: "1989-08-11", ticketType: "Standard", ticketPrice: "100", registeredDate: "2025-10-20", status: "Active", satisfactionScore: 4 },
    { id: "ar30", eventId: "105", name: "Salma Al-Anzi",      birthday: "2001-02-06", ticketType: "Standard", ticketPrice: "100", registeredDate: "2025-10-22", status: "Active", satisfactionScore: 5 },
    { id: "ar31", eventId: "105", name: "Majid Al-Subaie",    birthday: "1974-05-19", ticketType: "Standard", ticketPrice: "100", registeredDate: "2025-10-25", status: "Active", satisfactionScore: 3 },
    { id: "ar32", eventId: "105", name: "Hadeel Al-Rashidi",  birthday: "1998-11-30", ticketType: "Standard", ticketPrice: "100", registeredDate: "2025-11-01", status: "Active", satisfactionScore: 4 },
    ...
    { id: "ar34", eventId: "105", name: "Wafa Al-Mutairi",    birthday: "1993-07-08", ticketType: "Standard", ticketPrice: "100", registeredDate: "2025-11-08", status: "Active", satisfactionScore: 4 },

    // --- Riyadh Marathon (106) — 10 attendees ---
    { id: "ar35", eventId: "106", name: "Hassan Al-Shehri",   birthday: "1995-01-20", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-01", status: "Active", satisfactionScore: 5 },
    { id: "ar36", eventId: "106", name: "Fatimah Al-Dosari",  birthday: "2000-06-15", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-05", status: "Active", satisfactionScore: 4 },
    { id: "ar37", eventId: "106", name: "Sami Al-Harbi",      birthday: "1988-09-22", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-08", status: "Active", satisfactionScore: 5 },
    { id: "ar38", eventId: "106", name: "Reema Al-Qahtani",   birthday: "1979-03-11", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-10", status: "Active", satisfactionScore: 4 },
    { id: "ar39", eventId: "106", name: "Abdulrahman Nasser", birthday: "2003-12-05", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-12", status: "Active", satisfactionScore: 4 },
    { id: "ar40", eventId: "106", name: "Maryam Al-Bloushi",  birthday: "1971-08-18", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-15", status: "Active", satisfactionScore: 3 },
    ...
    { id: "ar42", eventId: "106", name: "Njoud Al-Otaibi",    birthday: "1984-10-13", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-20", status: "Active", satisfactionScore: 5 },
    { id: "ar43", eventId: "106", name: "Meshaal Al-Enezi",   birthday: "2005-07-01", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-22", status: "Active", satisfactionScore: 4 },
    { id: "ar44", eventId: "106", name: "Atheer Al-Zahrani",  birthday: "1991-11-09", ticketType: "Participant", ticketPrice: "50", registeredDate: "2026-02-25", status: "Active", satisfactionScore: 5 },

    // --- Cross-event loyal attendees ---
    { id: "ar45", eventId: "102", name: "Ahmed Al-Rashid",    birthday: "1998-05-12", ticketType: "General",    ticketPrice: "150", registeredDate: "2026-01-03", status: "Active", satisfactionScore: 5 },
    { id: "ar46", eventId: "103", name: "Ahmed Al-Rashid",    birthday: "1998-05-12", ticketType: "Executive",  ticketPrice: "750", registeredDate: "2026-01-22", status: "Active", satisfactionScore: 5 },
    { id: "ar47", eventId: "106", name: "Ahmed Al-Rashid",    birthday: "1998-05-12", ticketType: "Participant", ticketPrice: "50",  registeredDate: "2026-02-10", status: "Active", satisfactionScore: 4 },
    { id: "ar48", eventId: "103", name: "Khalid Al-Mutairi",  birthday: "1985-02-14", ticketType: "Standard",   ticketPrice: "450", registeredDate: "2026-01-28", status: "Active", satisfactionScore: 4 },
    { id: "ar49", eventId: "105", name: "Khalid Al-Mutairi",  birthday: "1985-02-14", ticketType: "Standard",   ticketPrice: "100", registeredDate: "2025-10-28", status: "Active", satisfactionScore: 5 },
    { id: "ar50", eventId: "102", name: "Badr Al-Harbi",      birthday: "1992-11-03", ticketType: "General",    ticketPrice: "150", registeredDate: "2026-01-06", status: "Active", satisfactionScore: 5 },
    { id: "ar51", eventId: "106", name: "Badr Al-Harbi",      birthday: "1992-11-03", ticketType: "Participant", ticketPrice: "50",  registeredDate: "2026-02-14", status: "Active", satisfactionScore: 4 },
    { id: "ar52", eventId: "105", name: "Sultan Al-Fahad",    birthday: "1978-03-08", ticketType: "Standard",   ticketPrice: "100", registeredDate: "2025-10-24", status: "Active", satisfactionScore: 4 },
    { id: "ar53", eventId: "106", name: "Amal Al-Ghamdi",     birthday: "1997-04-05", ticketType: "Participant", ticketPrice: "50",  registeredDate: "2026-02-06", status: "Active", satisfactionScore: 5 }
];
